...
基于 ESP32-S3 和 OV5640 (5MP) 摄像头的 WiFi 网络摄像头。支持 MJPEG 视频流、拍照、实时参数调节、自动对焦。

![芯片](https://img.shields.io/badge/ESP32--S3-OV5640-orange)
...
- **曝光控制** — 曝光补偿、自动/手动曝光、白平衡、增益
- **镜像/翻转** — 水平镜像、垂直翻转
- **自动对焦** — OV5640 连续自动对焦，支持手动微调
- **实时状态栏** — WiFi 名称、信号强度、上传带宽、CPU频率、信道、芯片温度、PSRAM、内存、运行时间
- **单客户端流** — 新连接自动断开旧连接，节省资源
- **连接超时** — 3 秒无响应自动断开，不占 socket
